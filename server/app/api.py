...
def log_rfid():
    try:
        ...
        print("Student {} logged for event {}".format(json.loads(get_student(rfid))["first_name"], json.loads(get_schedule())[int(json_obj['event_num'])]["name"]))
        return get_student(rfid), status.HTTP_200_OK
